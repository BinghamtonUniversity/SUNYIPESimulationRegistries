...
<nav class="navbar navbar-fixed-top navbar-default" style="background-color:#004c93;">
  <div class="container-fluid">
    ...
    <div class="navbar-header" style="width:100%;">
        <a class="navbar-brand" href="/" style="background: #004c93;padding: 12px 0px 0px 18px;">
            <h4 style="color:#fff;margin:0px;">SUNY IPE/Simulation Registries</h4>
        </a>
