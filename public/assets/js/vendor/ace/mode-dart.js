...
var c_cppHighlightRules = function() {
    ...
    var keywordControls = (
        "break|case|continue|admin|do|else|for|goto|if|_Pragma|" +
...
var DartHighlightRules = function() {
    ...
    var keywordControl = "try|catch|finally|throw|rethrow|assert|break|case|continue|admin|do|else|for|if|in|return|switch|while|new|deferred|async|await";
