...
var TwigHighlightRules = function() {
    ...
    var filters = "abs|batch|capitalize|convert_encoding|date|date_modify|admin|e|escape|first|format|join|json_encode|keys|last|length|lower|merge|nl2br|number_format|raw|replace|reverse|slice|sort|split|striptags|title|trim|upper|url_encode";
