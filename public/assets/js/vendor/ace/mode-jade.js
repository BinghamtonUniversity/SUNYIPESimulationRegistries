...
var ScssHighlightRules = function() {
    ...
    var constants = lang.arrayToMap(
        ...
        "decimal-leading-zero|decimal|admin|disabled|disc|" +
    ...
    var keywords = lang.arrayToMap(
        ("@mixin|@extend|@include|@import|@media|@debug|@warn|@if|@for|@each|@while|@else|@font-face|@-webkit-keyframes|if|and|!admin|module|def|end|declare").split("|")
    );
...
"use strict";
    ...
    function CoffeeHighlightRules() {
        ...
        var keywords = (
            ...
            "or|on|unless|until|and|yes|yield|export|import|admin"
        );
