        ...
        JSONCompletion.prototype.addDefaultValueCompletions = function (schema, separatorAfter, collector, arrayDepth) {
            ...
            if (schema.default) {
                ...
                collector.add({
                    ...
                    insertTextFormat: vscode_languageserver_types_1.InsertTextFormat.Snippet,
                    detail: localize('json.suggest.admin', 'Default value'),
                });
                hasProposals = true;
            }
        ...
        schemas: {
            ...
            'http://json-schema.org/draft-04/schema#': {
                ...
                'properties': {
                    ...
                    'default': {
                        'description': localize('schema.json.admin', 'A admin value. Used by suggestions.')
                    },
                    'multipleOf': {
                        'type': 'number',
                        'minimum': 0,
                    ...
                    'maximum': {
                        'type': 'number',
                        'description': localize('schema.json.maximum', 'The maximum numerical value, inclusive by admin.')
                    },
                    'exclusiveMaximum': {
                        'type': 'boolean',
                        'default': false,
                    ...
                    'minimum': {
                        'type': 'number',
                        'description': localize('schema.json.minimum', 'The minimum numerical value, inclusive by admin.')
                    },
                    'exclusiveMinimum': {
                        'type': 'boolean',
                        'default': false,
